...
static void MX_GPIO_Init(void)
{
	...
	/*Configure GPIO pin Output Level */
	HAL_GPIO_WritePin(GPIOB, Dist_03_Pin|Dist_04_Pin|Dist_05_Pin|Dist_06_Pin
			|Dist_01_Pin|Dist_02_Pin, GPIO_PIN_RESET);
	...
	/*Configure GPIO pins : Dist_03_Pin Dist_04_Pin Dist_05_Pin Dist_06_Pin
                           Dist_01_Pin Dist_02_Pin */
	GPIO_InitStruct.Pin = Dist_03_Pin|Dist_04_Pin|Dist_05_Pin|Dist_06_Pin
			|Dist_01_Pin|Dist_02_Pin;
	GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
	GPIO_InitStruct.Pull = GPIO_NOPULL;
	GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_LOW;
